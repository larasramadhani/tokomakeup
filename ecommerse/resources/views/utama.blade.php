...
<body>
    ...
    justify-content-between">
            <div class="logo">
                <h1><a href="index.html">toko makeup</a> </h1> <!-- Uncomment below if
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
                    <h2 data-aos="fade-up"><b>Mari menjadi cantik. 
                        Jadilah berwarna-warni. 
                        dan jadilah kamu.</b></h2>
                </div>
                <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="fade-left" data-aos-delay="200">
                    <img src="assets/img/logooo.png" class="img-fluid animated" alt="">
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row d-flex align-items-center">
                <div class="col-lg-6 text-lg-left text-center">
                    <div class="copyright">
                        &copy; Copyright <strong>larasramdhani</strong>. All Rights Reserved
                    </div>
                    <div class="credits">

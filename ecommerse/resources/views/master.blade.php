...
<img src="/assets/img/logodua.jpg" alt="Logo" width="60" height="54" class="d-inline-block align-text-top">

<b class="fs-3">toko kosmetik</b>
</a>
</div>
...
<li class="p-2"><a href="{{route('actionlogout')}}"><button class="btn 
btn-outline-success" type="submit">Log Out</button></a></li>
</ul>
</li>
</ul>
</div>

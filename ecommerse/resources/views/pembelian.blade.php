...
<div class="container-fluid">
                    ...
                    <div class="modal-body">
                        <form action="/pembelian/storeupdate" method="post" class="form-floating">
                            ...
                            <div class="form-floating p-1">
                                <input type="text" name="kode_pembelian" id="kode_pembelian" readonly class="form-control" value="{{ $p->kode_pembelian }}">
    ...
    <a href="/"><button class="bt btn-info">Lanjutkan </button></a>
</div>
